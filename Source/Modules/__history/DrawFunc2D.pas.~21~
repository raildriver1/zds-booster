...
procedure HookText(Font : Cardinal; X,Y : integer; Text : string; Color : integer; Alpha : integer = 255; Scale : real = 1.0); stdcall;
exports
  HookText;
...
procedure HookText(Font : Cardinal; X,Y : integer; Text : string; Color : integer; Alpha : integer = 255; Scale : real = 1.0); stdcall; export;
begin
  //DrawText2D(Font, X,Y, Text, Color, Alpha, Scale);

  DrawText2D(Font, X,Y, 'prikol hello', Color, Alpha, Scale);
